...
short int input_data[804*2];
short int input_data100[100*FRAMELENGTH*2];
//short int rxdata[23040*4*100];
signed short int txdata[15360*2*100];
signed short int rxdata[15360*2*100];
RADCONF RadConfig;
...
//    printf("in radio_init\n");
    ...
    radio_sampling_rate = -1; // to do: change this as an input of the radio init function
		...
		int radio_test_time)
{
    ...
    if (radio_test_time) {
        ...
        if (input_buffer_add != 0) {
            ...
            RadConfig.cfg4g.TxPlayBufSize = sizeof(input_data100);
