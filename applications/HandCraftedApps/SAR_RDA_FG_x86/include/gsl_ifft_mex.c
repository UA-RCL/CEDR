...
void __attribute__((always_inline)) gsl_ifft(double *, double *, size_t);

void __attribute__((always_inline)) gsl_ifft(double *input_array, double *output_array, size_t n_elements) {
