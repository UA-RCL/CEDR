...
void /* __attribute__((always_inline)) */ gsl_fft(double *, double *, size_t);

void /* __attribute__((always_inline)) */ gsl_fft(double *input_array, double *output_array, size_t n_elements) {
