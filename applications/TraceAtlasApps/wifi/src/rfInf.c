   ...
   switch(mediaType) {
      case DATFILE :
         if(mode == RXMODE) {
            ...
            //fp = fopen("/localhome/jmack2545/rcl/DASH-SoC/TraceAtlas/Applications/wifi/build/txdata.txt", "r");
            ...
            //fp = fopen("/localhome/jmack2545/rcl/DASH-SoC/TraceAtlas/Applications/wifi/build/txdata.txt", "w");
            //if(fp == NULL) {
