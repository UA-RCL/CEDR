...
static comp_t longPreamble[128] = {
    {-0.156, 0.000},  {0.012, -0.098},  {0.092, -0.106},  {-0.092, -0.115}, {-0.003, -0.054}, {0.075, 0.074},
    {-0.127, 0.021},  {-0.122, 0.017},  {-0.035, 0.151},  {-0.056, 0.022},  {-0.060, -0.081}, {0.070, -0.014},
    {0.082, -0.092},  {-0.131, -0.065}, {-0.057, -0.039}, {0.037, -0.098},  {0.062, 0.062},   {0.119, 0.004},
    {-0.022, -0.161}, {0.059, 0.015},   {0.024, 0.059},   {-0.137, 0.047},  {0.001, 0.115},   {0.053, -0.004},
    {0.098, 0.026},   {-0.038, 0.106},  {-0.115, 0.055},  {0.060, 0.088},   {0.021, -0.028},  {0.097, -0.083},
    {0.040, 0.111},   {-0.005, 0.120},  {0.156, 0.000},   {-0.005, -0.120}, {0.040, -0.111},  {0.097, 0.083},
    {0.021, 0.028},   {0.060, -0.088},  {-0.115, -0.055}, {-0.038, -0.106}, {0.098, -0.026},  {0.053, 0.004},
    {0.001, -0.115},  {-0.137, -0.047}, {0.024, -0.059},  {0.059, -0.015},  {-0.022, 0.161},  {0.119, -0.004},
    {0.062, -0.062},  {0.037, 0.098},   {-0.057, 0.039},  {-0.131, 0.065},  {0.082, 0.092},   {0.070, 0.014},
    {-0.060, 0.081},  {-0.056, -0.022}, {-0.035, -0.151}, {-0.122, -0.017}, {-0.127, -0.021}, {0.075, -0.074},
    {-0.003, 0.054},  {-0.092, 0.115},  {0.092, 0.106},   {0.012, 0.098},   {-0.156, 0.000},  {0.012, -0.098},
    {0.092, -0.106},  {-0.092, -0.115}, {-0.003, -0.054}, {0.075, 0.074},   {-0.127, 0.021},  {-0.122, 0.017},
    {-0.035, 0.151},  {-0.056, 0.022},  {-0.060, -0.081}, {0.070, -0.014},  {0.082, -0.092},  {-0.131, -0.065},
    {-0.057, -0.039}, {0.037, -0.098},  {0.062, 0.062},   {0.119, 0.004},   {-0.022, -0.161}, {0.059, 0.015},
    {0.024, 0.059},   {-0.137, 0.047},  {0.001, 0.115},   {0.053, -0.004},  {0.098, 0.026},   {-0.038, 0.106},
    {-0.115, 0.055},  {0.060, 0.088},   {0.021, -0.028},  {0.097, -0.083},  {0.040, 0.111},   {-0.005, 0.120},
    {0.156, 0.000},   {-0.005, -0.120}, {0.040, -0.111},  {0.097, 0.083},   {0.021, 0.028},   {0.060, -0.088},
    {-0.115, -0.055}, {-0.038, -0.106}, {0.098, -0.026},  {0.053, 0.004},   {0.001, -0.115},  {-0.137, -0.047},
    {0.024, -0.059},  {0.059, -0.015},  {-0.022, 0.161},  {0.119, -0.004},  {0.062, -0.062},  {0.037, 0.098},
    {-0.057, 0.039},  {-0.131, 0.065},  {0.082, 0.092},   {0.070, 0.014},   {-0.060, 0.081},  {-0.056, -0.022},
    {-0.035, -0.151}, {-0.122, -0.017}, {-0.127, -0.021}, {0.075, -0.074},  {-0.003, 0.054},  {-0.092, 0.115},
    {0.092, 0.106},   {0.012, 0.098}};
...
float matchedFiltering(comp_t *buf, int rIdx, comp_t *coef, int nTap) {
	KERN_ENTER(make_label("FIR[1D][1][t-%d][float32][complex][c-complex]", nTap));
	int i;
	float cor = 0.0;
	float real, imag;
	...
	KERN_EXIT(make_label("FIR[1D][1][t-%d][float32][complex][c-complex]", nTap));
...
int frameDetection() {
	...
	if (sIdx == 0) {
		...
		char *file5 = "Dash-RadioCorpus/QPR8_RFConvSys/rxdata.txt";
		char *path5 = (char *)malloc(FILEPATH_SIZE * sizeof(char));
		strcat(path5, getenv("DASH_DATA"));
		strcat(path5, file5);
		FILE *cfp5 = fopen(path5, "r");
		free(path5);

		if (cfp5 == NULL) {
			printf("in detection.c:\n\tFATAL: %s was not found!", file5);
			exit(1);
		}
		...
		while (fgets(buf, 81920, cfp5) != NULL) {
...
void *payloadExt(void *input) {
	comp_t *dbuf = ((struct args_payload *)input)->dbuf;
#endif
