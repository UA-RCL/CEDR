...
int main(int argc, char *argv[]) {
	...
	perf_counter hw_ctr, hw_ctr1, hw_ctr2, hw_ctr3, hw_ctr4, hw_ctr5, hw_ctr6, hw_ctr7, hw_ctr8, hw_ctr9, hw_ctr10,
	    hw_ctr11;
	...
	std::cout << "Average number of CPU cycles running hermitian in hardware: " << hw_cycles << std::endl;
	...
	std::cout << "Average number of CPU cycles running mmult in hardware: " << hw_cycles << std::endl;
	...
	std::cout << "Average number of CPU cycles running inverse in hardware: " << hw_cycles << std::endl;
	...
	std::cout << "Average number of CPU cycles running real part of inverse in hardware: " << hw_cycles << std::endl;
	...
	std::cout << "Average number of CPU cycles running imag part of inverse in hardware: " << hw_cycles << std::endl;
